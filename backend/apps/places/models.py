...
class Place(models.Model):
    """Model for caching place data from external APIs."""
    ...
    place_id = models.CharField(max_length=200, unique=True, help_text="External API place ID")
    ...
    opening_hours = models.JSONField(default=dict, help_text="Opening hours data")
...
class PlaceSearchQuery(models.Model):
    ...
    def __str__(self):
        location = f" near ({self.latitude}, {self.longitude})" if self.latitude and self.longitude else ""
